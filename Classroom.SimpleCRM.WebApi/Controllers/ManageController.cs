...
using Classroom.SimpleCRM.WebApi.Models.ManageViewModels;
...
namespace Classroom.SimpleCRM.WebApi.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        private readonly SignInManager<CrmIdentityUser> _signInManager;
        ...
        public ManageController(
          ...
          SignInManager<CrmIdentityUser> signInManager,
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("Classroom.SimpleCRM.WebApi"),
